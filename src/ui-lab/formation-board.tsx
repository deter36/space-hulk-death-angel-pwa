...
function Flank({ alienAttackStripUrl, alienDeathStripUrl, alienIdleStripUrl, alienSpriteUrl, broodlordAttackStripUrl, broodlordDeathStripUrl, broodlordSpriteUrl, controlPanelActionText, flank, moving, movementDirection, onInspect, onHoverInspect, onDismissHoverInspection, onSelectSwarm, onSelectTerrain, overlay, side, swarmAnimation, swarmState = "neutral", terrainStates = {}, terrainSpriteUrls }: { alienAttackStripUrl?: string; alienDeathStripUrl?: string; alienIdleStripUrl?: string; alienSpriteUrl: string; broodlordAttackStripUrl?: string; broodlordDeathStripUrl?: string; broodlordSpriteUrl?: string; controlPanelActionText?: string; flank: LabFlank; moving?: boolean; movementDirection?: "up" | "down" | "flank"; onInspect?: (details: LabInspection) => void; onHoverInspect?: (details: LabInspection, anchor: DOMRect) => void; onDismissHoverInspection?: () => void; onSelectSwarm: () => void; onSelectTerrain: (terrainId?: string) => void; overlay?: LabOverlayChoice; side: Side; swarmAnimation?: "attack" | "death"; swarmState?: LabTargetState; terrainStates?: Record<string, LabTargetState>; terrainSpriteUrls?: Partial<Record<string, string>> }) {
  ...
  return (
    <div className={`lab-flank lab-flank-${side.toLowerCase()} ${flank.swarm ? "is-engaged" : ""} ${flank.terrain ? "has-terrain" : ""} ${moving ? `is-swarm-moving is-swarm-moving-${movementDirection ?? "up"}` : ""}`}>
      ...
      })}</span><SwarmReadout swarm={flank.swarm} /></div>}
...
export default function FormationBoard({ alienAttackStripUrl, alienDeathStripUrl, alienIdleStripUrl, alienSpriteUrl, broodlordAttackStripUrl, broodlordDeathStripUrl, broodlordSpriteUrl, collapsingMarine, controlPanelActionText, locationProgress, marineAnimationStates = {}, marineDeathStripUrl, marineDodgeStripUrl, marineFireStripUrls, marineJamStripUrls, marineSpriteUrl, marineMoveChoices = [], moveSlots = [], movingSwarmCell, movingSwarmCells = {}, marineStates = {}, onInspect, onHoverInspect, onDismissHoverInspection, onMarineMoveChoice, onMoveSlot, onOverlayChoice, onSelectMarine, onSelectSwarm, onSelectTerrain, overlayChoices = [], rows, selectedMarine, swarmAnimationStates = {}, swarmStates = {}, terrainStates = {}, terrainSpriteUrls = {} }: FormationBoardProps) {
