  ...
  return (
    <main className="ui-lab-shell" style={style}>
      ...
      <div className="ui-lab-viewport">
        ...
        {demo === "action" ? <><div className="lab-choice-banner"><span>Blue team · Move + Activate</span><strong>Select a Marine</strong><em>Tap to choose · hold for details</em></div><FormationBoard rows={scenario.rows} marineSpriteUrl={`${assetBase}/marine-idle.gif`} alienSpriteUrl={`${assetBase}/alien-attack.gif`} alienIdleStripUrl="../game-art/genestealer/idle.png" broodlordSpriteUrl="../game-art/broodlord/idle.png" selectedMarine={selectedMarine} onSelectMarine={setSelectedMarine} onInspect={setInspection} /></> : <BoardInteraction key={demo} mode={demo} rows={INTERACTION_SCENARIO.rows} marineSpriteUrl={`${assetBase}/marine-idle.gif`} alienSpriteUrl={`${assetBase}/alien-attack.gif`} alienIdleStripUrl="../game-art/genestealer/idle.png" broodlordSpriteUrl="../game-art/broodlord/idle.png" onInspect={setInspection} />}
