...
export default function GameView({ assetBase }: { assetBase: string }) {
  ...
  return (
    <main className="lab-game-view" style={style}>
      ...
      <FormationBoard rows={scenario.rows} marineSpriteUrl={`${assetBase}/marine-idle.gif`} alienSpriteUrl={`${assetBase}/alien-attack.gif`} alienIdleStripUrl="../../game-art/genestealer/idle.png" broodlordSpriteUrl="../../game-art/broodlord/idle.png" terrainSpriteUrls={{ Door: "../../game-art/terrain/door-v1.png", "Control Panel": "../../game-art/terrain/control-panel-v1.png", "Promethium Tank": "../../game-art/terrain/promethium-tank-v1.png" }} selectedMarine={selectedMarine} onSelectMarine={setSelectedMarine} onInspect={setInspection} />
