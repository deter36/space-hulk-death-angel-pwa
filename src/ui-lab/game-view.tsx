...
export default function GameView({ assetBase }: { assetBase: string }) {
  ...
  return (
    <main className="lab-game-view" style={style}>
      ...
      <FormationBoard rows={scenario.rows} marineSpriteUrl={`${assetBase}/marine-idle.gif`} alienSpriteUrl={`${assetBase}/alien-attack.gif`} broodlordSpriteUrl="../../game-art/broodlord/idle.png" selectedMarine={selectedMarine} onSelectMarine={setSelectedMarine} onInspect={setInspection} />
